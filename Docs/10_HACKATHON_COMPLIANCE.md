...
- Theme: build an agent solving a meaningful real-world browser workflow; official statement says **build-your-own-solution** — THRU qualifies directly (real problem, WebCMD-core, working prototype)
...
## §2 — Judging (100 pts) → THRU mapping
| Criterion | Pts | THRU's answer | Demo beat |
|---|---|---|---|
...
**WebCMD centrality (evaluation gate):** webcmd is the THRU engine's exploration/execution core — name it in the video, the README, and be ready with file:line of every webcmd call (Prompt F audit output).
